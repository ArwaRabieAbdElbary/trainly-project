<template>
  <div class="bg-gray-50 min-h-screen flex flex-col items-center py-12 px-4 sm:px-8">
    <!-- Hero Section -->
    <div
    ...
    <!-- GYM & Fitness Section -->
    <div
      class="max-w-5xl w-full bg-white rounded-xl overflow-hidden shadow-md flex flex-col sm:flex-row mb-12"
    >
      <img
