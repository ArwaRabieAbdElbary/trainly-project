<template>
  <section class="min-h-screen">
    <h2 class="text-3xl font-[500] mb-2">Reviews</h2>
    ...
    <div
      ...
      class="flex flex-col justify-center items-center text-gray-500 h-[60vh]"
    >
      <svg
    ...
    <div v-else>
      <!-- 🔹 Statistics Section -->
      <div
        class="bg-white rounded-xl shadow-md p-8 flex flex-col md:flex-row justify-between items-center mb-10 border border-gray-400"
      >
        <!-- Average Rating -->
      ...
      <div class="space-y-5">
        <div
          ...
          :key="rev.id"
          class="bg-white rounded-xl  p-5 flex gap-4 shadow-lg shadow-gray-200  transition"
        >
          <img
          ...
          <div class="flex-1">
            ...
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-gray-500 text-sm">({{ rev.rating }}/5)</span>
            </div>
