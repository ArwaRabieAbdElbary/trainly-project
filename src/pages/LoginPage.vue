    ...
    >
      ...
      >
        ...
        <form @submit.prevent="handleLogin" class="w-full">
          <!-- Email -->
          <label for="email" class="text-sm text-black dark:text-white block mt-2 mb-1">Email</label>
          <input
            type="email"
            id="email"
            v-model="email"
          ...
          <a
            ...
            class="text-xs text-[#2d8fff] dark:text-[#6ab8ff] dark:hover:text-[#8ed0ff]
         transition-colors duration-300 hover:underline block text-right mb-4 cursor-pointer"
          >
            Forgot Password?
          </a>
